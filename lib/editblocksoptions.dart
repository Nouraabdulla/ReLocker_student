...
class editblocksoptions extends StatefulWidget {
  final String? from;
  final String? flour;
  final String? option;
  editblocksoptions({
  ...
  @override
  State<editblocksoptions> createState() => _editblocksoptionsState();
}
...
class _editblocksoptionsState extends State<editblocksoptions> {
  String floor = 'G';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text("Edit lockers options"),
        centerTitle: true,
      ...
      body: Stack(
        children: <Widget>[
          Pinned.fromPins(
            ...
            child: IconButton(
                icon: Image.asset('assets/images/DAlockers.png'),
                iconSize: 50,
                onPressed: () async {
          ...
          Pinned.fromPins(
            ...
            child: IconButton(
              icon: Image.asset('assets/images/changlockers.png'),
              iconSize: 50,
              onPressed: () {
                Navigator.of(context).push(MaterialPageRoute(
                    builder: (context) => locker_type(
