...
final String startDate;
  final String endDate;
    recommendations({Key? key,  required this.numberOfWeek,   required this.resId,  required this.floor, required this.startDate, required this.endDate}) : super(key: key);
